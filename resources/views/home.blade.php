...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link" data-widget="pushmenu" href="#" role="button"><i class="fas fa-chevron-circle-right"></i></a>
        </li>
    </ul>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
        ...
        <span class="brand-text font-weight-light">SIND1 </span><i style="margin-top: 6px;" data-widget="pushmenu" role="button" class="fas fa-chevron-circle-left float-right"></i>
    </a>
